...
epitope_contig = pd.read_csv("Ashwin/EpitopeContigs.tsv", sep="\t", index_col=None)
immunopeptide = pd.read_csv("Ashwin/immunopeptides_library_new.tsv", sep="\t", index_col=None)
mappings = pd.read_csv("Ashwin/mappings_new.tsv", sep="\t", index_col=None)
metadata = pd.read_csv("Ashwin/dataset_metadata.csv", sep=",", index_col=None)
epitope_pep = pd.read_csv("Ashwin/contigs_peptides.tsv", sep="\t", index_col=None)
...
# g.serialize(destination="proteogenomics_sample.owl", format='xml') # generates owl file
# # del g
# # g = rl.Graph()
# # g.parse("proteogenomics_impo_1.owl")
# print("  ------  over 1")
...
# g.serialize(destination="proteogenomics_study_spectrum.owl", format='xml') # generates owl file
# # del g
# # g = rl.Graph()
# # g.parse("proteogenomics_impo_2.owl")
# print("  ------  over 2")
...
# g.serialize("proteogenomics_assay_petide.owl",format="xml") # generates owl file
...
#     if k % 20000 == 0:
#         count_ += 1
#         g.serialize(destination="proteogenomics_spec_pep_id_{}.owl".format(count_), format='xml') # generates owl file
#         g = rl.Graph()
#         g.parse("ImPO_new.owl")
# del dict_spec

# g.serialize(destination="proteogenomics_spec_pep_id_final.owl".format(count_), format='xml') # generates owl file
# # del g
# # g = rl.Graph()
# # g.parse("proteogenomics_impo_3.owl")
# print("  ------  over 3")
...
for k in range(len(immunopeptide["sample ID"])):
    for j in range(len(metadata["Dataset_ID"])):
        if immunopeptide["sample ID"][k] == metadata["Dataset_ID"][j]:
            ...
            print(immunopeptide["sample ID"][k], "has source ", metadata["Tissue"][j])
            print(immunopeptide["sample ID"][k], "has type ", metadata["Source_Tissue"][k])

g.serialize(destination="proteogenomics_tumor_tissue_newver.owl", format='xml') # generates owl file
# # del g
# # g = rl.Graph()
# # g.parse("proteogenomics_impo_4.owl")
# print("  ------  over 4")
...
# g.serialize(destination="proteogenomics_contig.owl", format='xml') # generates owl file
# # del g
# # g = rl.Graph()
# # g.parse("proteogenomics_impo_5.owl")
# print("  ------  over 5")
...
# g.serialize(destination="proteogenomics_gene_prot_transcript.owl", format='xml') # generates owl file
# # del g
# # g = rl.Graph()
# # g.parse("proteogenomics_impo_6.owl")
# print("  ------  over 6")
...
#     if k % 400000 == 0:
#         count_ += 1
#         g.serialize(destination="proteogenomics_pep_prot_assig_{}.owl".format(count_), format='xml') # generates owl file
#         g = rl.Graph()
#         g.parse("ImPO_new.owl")
# del dict_peptide_pos

# g.serialize(destination="proteogenomics_pep_prot_assig_final.owl", format='xml') # generates owl file
# print("  ------  over THE END")
